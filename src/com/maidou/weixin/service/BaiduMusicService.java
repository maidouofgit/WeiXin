...
public class BaiduMusicService {
     ...
     * @return 
     */  
    public static String getSearchMusicUsage() {  
        StringBuffer buffer = new StringBuffer();  
        buffer.append("搜歌操作指南").append("\n\n");  
        buffer.append("回复：搜歌+歌名").append("\n");  
        buffer.append("例如：搜歌存在").append("\n");  
        buffer.append("或者：搜歌存在@汪峰").append("\n\n");  
